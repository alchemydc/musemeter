import { buildLocalEventDate, formatDisplayDate, formatDisplayTime } from '../../src/utils/date';

describe('date utils', () => {
  test('buildLocalEventDate constructs a local Date with given date and time components', () => {
    const dt = buildLocalEventDate('2025-09-12', '20:30');
  ...
  test('buildLocalEventDate defaults to midnight when time omitted', () => {
    const dt = buildLocalEventDate('2025-01-05');
    expect(dt.getFullYear()).toBe(2025);
