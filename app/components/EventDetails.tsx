...
const EventDetails: React.FC<EventDetailsProps> = ({ eventId }) => {
    ...
    return (
      <div className="animate-pulse space-y-4">
        ...
        <div className="flex gap-2 pt-2">
          <div className="h-9 bg-surface-200 dark:bg-surface-700 rounded-full w-32"></div>
          <div className="h-9 bg-surface-200 dark:bg-surface-700 rounded-full w-32"></div>
        </div>
      </div>
    );
  ...
  if (error) {
    return (
      <div className="p-4 rounded-xl border-l-4 border-red-500 bg-red-50 dark:bg-red-900/20">
